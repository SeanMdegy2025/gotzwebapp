...
export default function AdminDestinationsEditPage() {
  ...
  const [dest, setDest] = useState<AdminDestination | null>(null);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    updateAdminDestination(dest.id, payload)
  ...
  if (!dest) {
    return (
      <div className="px-4 py-6 sm:px-6 lg:px-8">
        ...
        <Link href="/admin/destinations" className="mt-2 text-sm text-safari-green hover:underline">
          ...
          <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
            <div className="space-y-6 p-6">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">Extra images shown on the home page destination card and modal. Order: first = card image when no main image.</p>
