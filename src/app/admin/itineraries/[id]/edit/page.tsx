    ...
    getAdminItinerary(id)
      .then((r) => {
        ...
        setForm({
          ...
          images: (it.images ?? []).map((img) => ({ image_base64: img.image_base64 })),
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl space-y-6">
          ...
          <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
            <div className="space-y-6 p-6">
              <div>
                <label className="block text-sm font-medium text-gray-700">Main safari image (card/hero)</label>
                <input
                  type="file"
                  accept="image/*"
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">Extra images shown on the safari detail page. Order: first = left.</p>
